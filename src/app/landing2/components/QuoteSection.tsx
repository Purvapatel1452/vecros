...
export default function QuoteSection() {
  return (
    <section className="w-full py-20" style={{ backgroundColor: COLORS.pink }}>
      <div className="max-w-6xl mx-auto px-8">
        <div className="text-center relative">
          {/* Large Quote Marks */}
          <div className="text-8xl md:text-9xl text-orange-300 mb-8 opacity-60">"</div>
          ...
          {/* Attribution */}
          <p className="text-lg text-black font-medium mb-12">Quote by Joy Barry</p>
          
          {/* Pagination Dots */}
          <div className="flex justify-center items-center gap-3">
            <div className="w-3 h-3 bg-orange-300 rounded-full opacity-50"></div>
            <div className="w-3 h-3 bg-orange-300 rounded-full opacity-50"></div>
